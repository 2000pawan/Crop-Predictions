...
def main():
    ...
    <h4 style= 'color: #000000; text-align: left; font-size: 20px;'> 👉 “Customize this model with your country’s crop type, total pesticide used to cultivated all over area where this crop grow, average rainfall, average temperature data to generate accurate yield insights.”</h4>
    </div>
